...
export default async function getPostText() 
{
	...
	for (let i = 0; i < limitVal; i++) // Iterate over all the posts we collected using the Mastodon API. 
	{
		...
		if (contentString.includes("@Kamille_brick") || contentString.includes("further accentuates") || contentString.includes("AEW World Championship") || contentString.includes("@RicFlairNatrBoy") || contentString.includes("better than you") || contentString.includes("AEW World Champion") || contentString.includes("MJF") || contentString.includes("@DraftKings"))
		{
			contentString = "";
		}
